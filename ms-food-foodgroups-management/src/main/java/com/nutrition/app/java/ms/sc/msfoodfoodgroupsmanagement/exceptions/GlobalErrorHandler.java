...
public class GlobalErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleModelNotFoundException(ModelNotFoundException e, WebRequest request) {
        ErrorDTO errorDTO = new ErrorDTO(LocalDateTime.now(), e.getMessage(), request.getDescription(false));
